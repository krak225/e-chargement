						...
						<section class="w-f scrollable"> 
							...
							<nav class="nav-primary hidden-xs"> 
								<ul class="nav">
									...
									<?php if(auth()->guard()->check()): ?>
									<li class="<?php if(Request::is('declarations')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
										 ...
										 <ul class="nav lt"> 
											<li class=""> 
												<a href="<?php echo e(route('declarations')); ?>" class="active"> 
									...
									<li class="<?php if(Request::is('chargements')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
											 <i class="fa fa-users icon"> 
											 <b class="bg-info"></b> </i> 
											 <span class="pull-right"> 
										 ...
										 <ul class="nav lt"> 
											<li class=""> 
												<a href="<?php echo e(route('chargements')); ?>" class="active"> 
												<i class="fa fa-angle-right"></i> 
									...
									<li class="<?php if(Request::is('empotages')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
											 <i class="fa fa-users icon"> 
											 <b class="bg-info"></b> </i> 
											 <span class="pull-right"> 
									...
									<li class="<?php if(Request::is('declarants')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
											 <i class="fa fa-users icon"> 
											 <b class="bg-info"></b> </i> 
											 <span class="pull-right"> 
										 ...
										 <ul class="nav lt"> 
											<li class=""> 
												<a href="<?php echo e(route('declarants')); ?>" class="active"> 
												<i class="fa fa-angle-right"></i> 
									...
									<li class="<?php if(Request::is('expediteurs')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
											 <i class="fa fa-users icon"> 
											 <b class="bg-info"></b> </i> 
											 <span class="pull-right"> 
										 ...
										 <ul class="nav lt"> 
											<li class=""> 
												<a href="<?php echo e(route('expediteurs')); ?>" class="active"> 
												<i class="fa fa-angle-right"></i> 
									...
									<li class="<?php if(Request::is('destinataires')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
											 <i class="fa fa-users icon"> 
											 <b class="bg-info"></b> </i> 
											 <span class="pull-right"> 
										 ...
										 <ul class="nav lt"> 
											<li class=""> 
												<a href="<?php echo e(route('destinataires')); ?>" class="active"> 
												<i class="fa fa-angle-right"></i> 
									...
									<li class="<?php if(Request::is('agent_douanes')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
											 <i class="fa fa-users icon"> 
											 <b class="bg-info"></b> </i> 
											 <span class="pull-right"> 
										 ...
										 <ul class="nav lt"> 
											<li class=""> 
												<a href="<?php echo e(route('agent_douanes')); ?>" class="active"> 
												<i class="fa fa-angle-right"></i> 
									...
									<li class="<?php if(Request::is('frais_livraison')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
											 <i class="fa fa-cogs icon"> 
											 <b class="bg-info"></b> </i> 
											 <span class="pull-right"> 
										 ...
										 <ul class="nav lt"> 
											<li class=""> 
												<a href="<?php echo e(route('frais_livraison')); ?>" class="active"> 
												<i class="fa fa-angle-right"></i> 
									...
									<li class="<?php if(Request::is('utilisateurs')): ?> active <?php endif; ?>"> 
										 <a href="#" class=""> 
											 <i class="fa fa-users icon"> 
											 <b class="bg-info"></b> </i> 
											 <span class="pull-right"> 
