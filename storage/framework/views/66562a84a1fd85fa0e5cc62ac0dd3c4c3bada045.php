			...
			<div class="col-sm-6"> 
				<section class="panel panel-default"> 
					...
					<div class="list-group no-radius alt"> 
						...
						<span class="list-group-item"> 
							<span class="badge bg-light"><?php echo e(Stdfn::dateTimeFromDB($vehicule->vehicule_date_sortie1)); ?></span> 
							<i class="fa fa- icon-muted"></i> Date sortie 1
						</span>
						<span class="list-group-item"> 
							<span class="badge bg-light"><?php echo e(Stdfn::dateTimeFromDB($vehicule->vehicule_date_entree2)); ?></span> 
							<i class="fa fa- icon-muted"></i> Date d'entrée 2
						</span>
						<span class="list-group-item"> 
							<span class="badge bg-light"><?php echo e(Stdfn::dateTimeFromDB($vehicule->vehicule_date_sortie2)); ?></span> 
						...
						<span class="list-group-item">
							<?php if(Auth::user()->profil_id == 3): ?>
								<span class="bg-light"><span class="label btn-warning btnEntreeSortieVehicule" data-situation="sp1" data-vehicule_id="<?php echo e($vehicule->vehicule_id); ?>" style="cursor:pointer;" data-title="Véhicule sorti du poste 1" title="Indiquer que le véhicule est sorti du poste 1"><i class="fa fa-edit"></i> Véhicule sorti du poste 1</span></span> 
							<?php endif; ?>
							<?php if(Auth::user()->profil_id == 4): ?>
								<span class="bg-light"><span class="label btn-success btnEntreeSortieVehicule" data-situation="ep2" data-vehicule_id="<?php echo e($vehicule->vehicule_id); ?>" style="cursor:pointer;" data-title="Véhicule est entré au poste 2" title="Indiquer que le véhicule est entré au poste 2"><i class="fa fa-edit"></i> Véhicule entré au poste 2</span></span> 
							<?php endif; ?>
							<?php if(Auth::user()->profil_id == 5): ?>
								<span class="bg-light"><span class="label btn-danger btnEntreeSortieVehicule" data-situation="sp2" data-vehicule_id="<?php echo e($vehicule->vehicule_id); ?>" style="cursor:pointer;" data-title="Véhicule sorti du poste 2" title="Indiquer que le véhicule est sorti du poste 2"><i class="fa fa-edit"></i> Véhicule sorti du poste 2</span></span> 
							<?php endif; ?>
						</span>
