				...
				<div class="form-group<?php echo e($errors->has('expediteur_nom') ? ' has-error' : ''); ?>">
					...
					<div class="col-md-12 row">
						...
						<div class="col-md-5">
							...
							<input placeholder="" type="text" class="form-control" name="expediteur_nom"  value="<?php echo e(old('expediteur_nom')); ?>" required>
						</div>
						
						<div class="col-md-5">
							<span> Description<span class="text text-danger"></span></span>
							<input style="padding-top:0px;" placeholder="" type="text" class="form-control" name="expediteur_description" value="<?php echo e(old('expediteur_description')); ?>">
						</div>
					...
					<div class="col-md-12 row" style="margin-top:10px;">	
						...
						<!--div class="col-md-2">
							...
							<input style="padding-top:0px;" placeholder="" type="number" class="form-control" name="expediteur_stock" value="<?php echo e(old('expediteur_stock')); ?>" >
