				...
				<div class="form-group<?php echo e($errors->has('empotage_nom') ? ' has-error' : ''); ?>">
					...
					<div class="col-md-12 row">
						...
						<div class="col-md-5">
							...
							<input style="padding-top:0px;" placeholder="" type="text" class="form-control" name="empotage_description" value="<?php echo e(old('empotage_description')); ?>">
						</div>
					...
					<div class="col-md-12 row" style="margin-top:10px;">	
						...
						<!--div class="col-md-2">
							...
							<input style="padding-top:0px;" placeholder="" type="number" class="form-control" name="empotage_stock" value="<?php echo e(old('empotage_stock')); ?>" >
