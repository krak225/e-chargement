...
<ul class="breadcrumb no-border no-radius b-b b-light pull-in"> 
	...
	<li class="active">{{ ucfirst(strtolower($declaration->declaration_numero)) }}</li> 
</ul> 

<div class="m-b-md"> 
	<h3 class="m-b-none">{{ $declaration->declaration_numero }}</h3>
</div>
...
<div class="panel panel-default"> 
				...
				<section class="panel panel-default"> 
					<header class="panel-heading bg-info lt no-border title"> 
						<div class="clearfix"> 
							...
							<small style="color:white;">Informations sur la declaration</small>
							<span class="btnModifierDeclaration pull-right " data-declaration_id="{{$declaration->declaration_id}}" style="cursor: pointer;"><i class="fa fa-edit text-white" title="Modifier"></i></span>
					...
					<div class="list-group no-radius alt"> 
						<div class="list-group-item"> 
							<span class="badge bg-light" style="background: none;"><span class="label label-default" style="font-size: 100%;">{{ Stdfn::truncateN($declaration->declaration_id,5) }}</span></span> 
							<i class="fa fa- icon-muted"></i> Numéro du declaration
						</div> 
						<span class="list-group-item"> 
							<span class="badge bg-light">{{ $declaration->declaration_numero }}</span> 
							<i class="fa fa- icon-muted"></i> Nom du declaration 
						</span>		
						<span class="list-group-item"> 
							<span class="badge bg-light">{{ $declaration->declaration_numero}}</span> 
					...
					<div class="col-md-12" style="padding:0px;">
						<div style="height:200px;max-height:200px;overflow:auto;">
							<table class="table table-responsive" id="table_pieces_jointes"> 
								<tr>
									<td> 
										<img src="{{asset('images/declarations/'.$declaration->declaration_photo) }}" style="width:100%;height:auto;"/>
									</td>
								</tr>
							</table>    
						</div>

						<form method="post" action="{{route('UpdateDeclarationPhoto', $declaration->declaration_id)}}" enctype="multipart/form-data" class="dropzone" id="dropzone_principale">
							{!! csrf_field() !!}
		...
		<br style="clear:both;"/>	
					...
					<div class="panel panel-default" style="padding-bottom:10px;"> 
						...
						{
							paramName: "declarations_fichiers",
							disablePreview: true,
							capture: null,
							...
							success: function(file, response) 
							{
								...
								var img_preview_src = '{{asset("images/declarations")}}/'+response.autreimage_photo;
						...
						<div class="row col-lg-12"> 
							...
							<div class="col-sm-12"> 
								...
								<div class="col-md-5" style="border-right:1px dotted #eee;">
									<form method="post" action="{{route('UpdateFichiers',[$declaration->declaration_id])}}" enctype="multipart/form-data" class="dropzone" id="dropzone">
										{!! csrf_field() !!}
								...
								<div class="col-md-7" id="table_fichiers_traitement">
									...
									<a target="_blank" href="{{ route('ShowPieceJointe',$fichier->autreimage_id) }}" class="apercu_fichier">
										<img src="{{asset('images/declarations/'.$fichier->autreimage_photo) }}" style="border:1px solid #717171;margin:2px;width:100px;height:auto;"/>
									</a>
									@endforeach
								</div>
