...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 08 mai 2023 à 23:17
...
--
-- Base de données : `echargement_db`
--

-- --------------------------------------------------------

--
-- Structure de la table `agent_douane`
--

DROP TABLE IF EXISTS `agent_douane`;
CREATE TABLE IF NOT EXISTS `agent_douane` (
  `agent_douane_id` int NOT NULL AUTO_INCREMENT,
  ...
  `agent_douane_tel` varchar(25) NOT NULL,
  `agent_douane_mail` varchar(50) NOT NULL,
  `agent_douane_grade` enum('AGENT DE BRIGADE','LIEUTENANT','CAPITAINE','COMMANDANT') NOT NULL,
...
--
-- Déchargement des données de la table `agent_douane`
--

INSERT INTO `agent_douane` (`agent_douane_id`, `agent_douane_date_creation`, `agent_douane_matricule`, `agent_douane_nom_prenoms`, `agent_douane_date_naiss`, `agent_douane_lieu_naiss`, `agent_douane_date_ambauche`, `agent_douane_tel`, `agent_douane_mail`, `agent_douane_grade`, `agent_douane_user`, `agent_douane_date_modification`, `agent_douane_date_suppression`, `agent_douane_statut`) VALUES
(1, '2023-04-04 09:04:16', 'a345567', 'koffi konan antoine', '2023-04-02', 'bangolo', '2023-04-17', '', '', 'AGENT DE BRIGADE', 'koi', '2023-04-25 11:04:16', '2023-04-25 11:04:16', 'valide'),
(2, '2023-04-19 09:04:16', 'a6670e', 'yapo ange bernard', '2023-04-04', 'bouake', '2023-04-02', '', '', 'AGENT DE BRIGADE', 'albert', '2023-04-25 11:04:16', '2023-04-25 11:04:16', 'valide');

-- --------------------------------------------------------

--
-- Structure de la table `autreimage`
--

DROP TABLE IF EXISTS `autreimage`;
CREATE TABLE IF NOT EXISTS `autreimage` (
  `autreimage_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Déchargement des données de la table `autreimage`
--
...
--
-- Structure de la table `bureau_sortie`
--

DROP TABLE IF EXISTS `bureau_sortie`;
CREATE TABLE IF NOT EXISTS `bureau_sortie` (
  `bureau_sortie_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Déchargement des données de la table `bureau_sortie`
--
...
(1, '2023-05-02 23:04:41', 'BUREAU 1', '', NULL, NULL, 'valide');
...
CREATE TABLE IF NOT EXISTS `categorie` (
  ...
  `categorie_id_parent` int DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `chargement` (
  `chargement_id` int NOT NULL,
  `pays_id` int NOT NULL,
  `moyen_transport_id` int NOT NULL,
...
(1, '2023-05-03 00:14:15', 'CTN001', NULL, '2023-05-03 02:14:23', '2023-05-03 02:14:23', 'valide');

-- --------------------------------------------------------

--
-- Structure de la table `cotation_declaration`
--

DROP TABLE IF EXISTS `cotation_declaration`;
CREATE TABLE IF NOT EXISTS `cotation_declaration` (
  `agent_douane_id` int NOT NULL,
...
--
-- Structure de la table `cotation_declaration_effectif`
--

DROP TABLE IF EXISTS `cotation_declaration_effectif`;
CREATE TABLE IF NOT EXISTS `cotation_declaration_effectif` (
  `role_id` int NOT NULL,
  `agent_douane_id` int NOT NULL,
  `chargement_id` int NOT NULL,
  `detail_chargement_id` int NOT NULL,
...
--
-- Structure de la table `cotation_empotage`
--

DROP TABLE IF EXISTS `cotation_empotage`;
CREATE TABLE IF NOT EXISTS `cotation_empotage` (
  `role_id` int NOT NULL,
  `agent_douane_id` int NOT NULL,
  `empotage_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `declarant` (
  `declarant_id` int NOT NULL AUTO_INCREMENT,
...
(1, '2023-04-25 08:40:58', 'declarant-01', 'bp 234 abidjan 01', '08066543', '01977654', 'ben', '2023-04-25 10:40:58', '2023-04-25 10:40:58', 'valide'),
(2, '2023-04-18 08:40:58', 'declarant-2', '02 bp 34488 ferke 02', '0255664432', '0133557799', 'kra', '2023-04-25 10:40:58', '2023-04-25 10:40:58', 'valide');
...
(1, 1, 1, 1, 1, 1, 1, 1, 1, '2023-05-02 22:25:25', '2023-05-03', '2023-05-03', '2023-05-03', 'decla-01', 'digui', '2023-04-25 10:28:03', '2023-04-25 10:28:03', 'valide'),
(2, 2, 2, 2, 2, 2, 2, 2, 2, '2023-05-02 22:25:26', '2023-05-03', '2023-05-03', '2023-05-03', 'decla-2', 'abodou', '2023-04-25 10:28:03', '2023-04-25 10:28:03', 'valide');
...
CREATE TABLE IF NOT EXISTS `destinataire` (
  `destinataire_id` int NOT NULL AUTO_INCREMENT,
...
(1, '2023-04-03 08:59:20', 'destinataire-01', 'bp 34466 agboville ', '0525668899', '@yahoo.fr', 'car', '2023-04-25 10:59:20', '2023-04-25 10:59:20', 'valide'),
(2, '2023-04-19 08:59:20', 'destinataire-02', '01 bp 334466 bigerville 01', '04566773', '@gmail.com', 'youl', '2023-04-25 10:59:20', '2023-04-25 10:59:20', 'valide');

-- --------------------------------------------------------

--
-- Structure de la table `detail_chargement`
--

DROP TABLE IF EXISTS `detail_chargement`;
CREATE TABLE IF NOT EXISTS `detail_chargement` (
  ...
  `conteneur_id` int NOT NULL,
  `detail_declaration_id` int NOT NULL,
...
--
-- Structure de la table `detail_declaration`
--

DROP TABLE IF EXISTS `detail_declaration`;
CREATE TABLE IF NOT EXISTS `detail_declaration` (
  `detail_declaration_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Déchargement des données de la table `detail_declaration`
--
...
(1, 1, 1, 1, 0, '2023-05-02 23:59:38', NULL, NULL, 14000, NULL, NULL, '15000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-05-03 01:59:38', '2023-05-03 01:59:38', 'brouillon'),
(2, 1, 1, 1, 0, '2023-05-03 00:00:55', NULL, NULL, 5, NULL, NULL, '45', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'valide'),
(1, 1, 1, 2, 0, '2023-05-03 00:18:40', NULL, NULL, 2, 2, NULL, '10000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'valide'),
(1, 1, 1, 2, 1, '2023-05-03 00:20:59', NULL, NULL, 3000, 15000, NULL, '750000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'valide'),
(2, 2, 1, 2, 1, '2023-05-03 10:53:58', NULL, NULL, 2, 2, NULL, '300', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'valide');

-- --------------------------------------------------------

--
-- Structure de la table `detail_empotage`
--

DROP TABLE IF EXISTS `detail_empotage`;
...
--
-- Structure de la table `dim_commune`
--

DROP TABLE IF EXISTS `dim_commune`;
...
--
-- Déchargement des données de la table `dim_commune`
--
...
--
-- Structure de la table `dim_course`
--
...
CREATE TABLE IF NOT EXISTS `dim_course` (
  ...
  `commune_id_retrait` int DEFAULT NULL,
  `commune_id_livraison` int DEFAULT NULL,
  `frais_livraison` int DEFAULT NULL,
...
--
-- Structure de la table `dim_frais_livraison`
--

DROP TABLE IF EXISTS `dim_frais_livraison`;
CREATE TABLE IF NOT EXISTS `dim_frais_livraison` (
  `frais_livraison_id` int NOT NULL AUTO_INCREMENT,
  `commune_id_retrait` int NOT NULL,
  `commune_id_livraison` int NOT NULL,
  `frais_livraison_montant` int NOT NULL,
...
--
-- Déchargement des données de la table `dim_frais_livraison`
--
...
--
-- Structure de la table `empotage`
--

DROP TABLE IF EXISTS `empotage`;
CREATE TABLE IF NOT EXISTS `empotage` (
  `empotage_id` int NOT NULL AUTO_INCREMENT,
  `pays_id` int NOT NULL,
  `declarant_id` int NOT NULL,
...
--
-- Déchargement des données de la table `empotage`
--
...
--
-- Structure de la table `entree_sortie`
--

DROP TABLE IF EXISTS `entree_sortie`;
...
CREATE TABLE IF NOT EXISTS `expediteur` (
  `expediteur_id` int NOT NULL AUTO_INCREMENT,
...
(1, '2023-04-25 08:46:43', 'exportateur-01', '04 bp 3366 daloa 04', '010755443321', '@yahoo.fr', 'denver', '2023-04-25 10:46:42', '2023-04-25 10:46:42', 'valide'),
(2, '2023-04-03 08:46:43', 'expediteur-02', 'bp 33448 abidjan 02', '075544332214', '@gmail.com', 'ali', '2023-04-25 10:46:42', '2023-04-25 10:46:42', 'valide');
...
DROP TABLE IF EXISTS `kw_administrateur`;
CREATE TABLE IF NOT EXISTS `kw_administrateur` (
  `kw_administrateur_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `kw_administrateur_rang` int NOT NULL,
...
(1, '2023-05-02 23:42:18', 'M0001', 'ORDINATEURS', NULL, NULL, NULL, NULL, 'valide'),
(2, '2023-05-02 23:44:04', 'M0002', 'DISQUES DURS', NULL, NULL, NULL, NULL, 'valide');
...
CREATE TABLE IF NOT EXISTS `moyen_transport` (
  `moyen_transport_id` int NOT NULL AUTO_INCREMENT,
...
(1, '2023-05-02 23:06:55', 'BATEAU', NULL, NULL, NULL, 'valide');
...
CREATE TABLE IF NOT EXISTS `panier` (
  ...
  `produit_id` int NOT NULL,
  `panier_produit_pu` int NOT NULL,
  `session_id` int NOT NULL,
  `panier_quantite` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `parametre` (
  ...
  `parametre_code` varchar(25) NOT NULL,
  `parametre_libelle` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `parametre_valeur` varchar(10) NOT NULL,
  `parametre_date_creation` datetime DEFAULT NULL,
  `parametre_statut` enum('VALIDE','CLOTURE') NOT NULL DEFAULT 'VALIDE',
...
INSERT INTO `parametre` (`parametre_id`, `parametre_code`, `parametre_libelle`, `parametre_valeur`, `parametre_date_creation`, `parametre_statut`) VALUES
(1, 'DUREE_STA', 'Durée de stationnement', '10', '2023-05-08 23:28:34', 'VALIDE');
...
DROP TABLE IF EXISTS `plomb`;
CREATE TABLE IF NOT EXISTS `plomb` (
  `plomb_id` int NOT NULL,
  `conteneur_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `produit` (
  ...
  `produit_stock` int DEFAULT NULL,
...
(1, '2023-05-02 23:06:02', 'Régime 1', NULL, NULL, NULL, 'valide');
...
CREATE TABLE IF NOT EXISTS `tb_action` (
  ...
  `user_id_creation` int NOT NULL DEFAULT '0',
  `user_id_suppression` int NOT NULL DEFAULT '0',
...
--
-- Structure de la table `tb_autorisation`
--

DROP TABLE IF EXISTS `tb_autorisation`;
CREATE TABLE IF NOT EXISTS `tb_autorisation` (
  `autorisation_id` int NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `tb_participants`
--
...
CREATE TABLE IF NOT EXISTS `tb_participants` (
  ...
  `participant_contact` int NOT NULL,
...
--
-- Déchargement des données de la table `tb_participants`
--
...
(979, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(980, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(981, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(982, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(983, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(984, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(985, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(986, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(987, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(988, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(989, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(990, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(991, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(992, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(993, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(994, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(995, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(996, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(997, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(998, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(999, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1000, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1001, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1002, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1003, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1004, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1005, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1006, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1007, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1008, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1009, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1010, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1011, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1012, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1013, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1014, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1015, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1016, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1017, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1018, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1019, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1020, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1021, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1022, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1023, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1024, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1025, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1026, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1027, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1028, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1029, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1030, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1031, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1032, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1033, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1034, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1035, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1036, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1037, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1038, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1039, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1040, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1041, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1042, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1043, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1044, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1045, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1046, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1047, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1048, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1049, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1050, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1051, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1052, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1053, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1054, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1055, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1056, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1057, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1058, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1059, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1060, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1061, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1062, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1063, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1064, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1065, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1066, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1067, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1068, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1069, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1070, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1071, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1072, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1073, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1074, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1075, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1076, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1077, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1078, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1079, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1080, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1081, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1082, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1083, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1084, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1085, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1086, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1087, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1088, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1089, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1090, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1091, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1092, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1093, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1094, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1095, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1096, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1097, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1098, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1099, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1100, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1101, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1102, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1103, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1104, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1105, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1106, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1107, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1108, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1109, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1110, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1111, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1112, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1113, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1114, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1115, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1116, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1117, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1118, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1119, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1120, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1121, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1122, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1123, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1124, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1125, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1126, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1127, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1128, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1129, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1130, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1131, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1132, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1133, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1134, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1135, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1136, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1137, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1138, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1139, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1140, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1141, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1142, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1143, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1144, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1145, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1146, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1147, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1148, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1149, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1150, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1151, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1152, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1153, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1154, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1155, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1156, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1157, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1158, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1159, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1160, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1161, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1162, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1163, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1164, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1165, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1166, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1167, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1168, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1169, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1170, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1171, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1172, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1173, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1174, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1175, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1176, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1177, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1178, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1179, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1180, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1181, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1182, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1183, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1184, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1185, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1186, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1187, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1188, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1189, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1190, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1191, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1192, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1193, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1194, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1195, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1196, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1197, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1198, 'http://127.0.0.1:8000/images/empotages', 'images/empotages', 'brouillon'),
(1199, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1200, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1201, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1202, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1203, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1204, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1205, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1206, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1207, 'http://127.0.0.1:8000/images/expediteurs', 'images/expediteurs', 'brouillon'),
(1208, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1209, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1210, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1211, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1212, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1213, 'http://127.0.0.1:8000/css/select2x2.png', 'css/select2x2.png', 'brouillon'),
(1214, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1215, 'http://127.0.0.1:8000/images/destinataires', 'images/destinataires', 'brouillon'),
(1216, 'http://127.0.0.1:8000/images/agent_douanes', 'images/agent_douanes', 'brouillon'),
(1217, 'http://127.0.0.1:8000/images/declarants', 'images/declarants', 'brouillon'),
(1218, 'http://127.0.0.1:8000/vehicules_sous_penalite', 'vehicules_sous_penalite', 'brouillon');

-- --------------------------------------------------------

--
-- Structure de la table `tb_reunion_participant`
--

DROP TABLE IF EXISTS `tb_reunion_participant`;
...
--
-- Déchargement des données de la table `tb_reunion_participant`
--
...
CREATE TABLE IF NOT EXISTS `tb_service` (
  ...
  `service_numero_ordre_imputation_dg` int DEFAULT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COMMENT='ex : bureau urbain, antenne de san pédro, siège, etc.';
...
CREATE TABLE IF NOT EXISTS `tb_users` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `profil_id` int NOT NULL DEFAULT '2',
  `service_id` int UNSIGNED NOT NULL DEFAULT '0',
  `categorie_personnel_id` int UNSIGNED NOT NULL DEFAULT '0',
  `type_personnel_id` int UNSIGNED NOT NULL DEFAULT '0',
  `equipe_id` int UNSIGNED NOT NULL DEFAULT '0',
  `bureauid` int UNSIGNED NOT NULL DEFAULT '0',
  `nom` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `prenoms` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `civilite` enum('m.','mme','mlle') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `date_naissance` date DEFAULT NULL,
  `telephone` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `matricule` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `photo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `adresse_email` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  ...
  `ip_derniere_connexion` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `date_derniere_connexion` datetime DEFAULT NULL,
  `statut_connexion` enum('connecte','deconnecte') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'deconnecte',
  `statut_signature` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `statut` enum('VALIDE','SUPPRIME') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'VALIDE',
  PRIMARY KEY (`id`),
...
(2, 2, 1, 1, 1, 0, 0, 'DIGUI', 'BERENGER', 'm.', '2020-06-06', '0778607985', NULL, 'ph2_1683576035517télécharger.jpg', '', 'berenger', '$2y$10$tkKteQYut.uykNHXMxZKs.tDPVeTFW1W7Qb6RfV3DovfNDctfogJC', 'Aksvoe3i7MYm4z28sviNntJeIiBOOpA3H0NwPRC6hvs7KfNyxvp2NBfY3qvS', '2021-03-09 21:00:00', '2023-05-08 20:49:08', '127.0.0.1', '2023-05-08 22:49:08', 'connecte', NULL, 'VALIDE'),
(1, 1, 1, 1, 1, 0, 0, 'AKO', 'WILLY', 'm.', '2020-06-06', '0708031746', NULL, 'ph1_1620901561048ph4_1615373851975135160607_10164592007005223_8140133135769055267_o.jpg', '', 'ako', '$2y$10$tkKteQYut.uykNHXMxZKs.tDPVeTFW1W7Qb6RfV3DovfNDctfogJC', 'uJ1nk3hZyzevXCfUXXvBO3piXqzH1IIFoQsiYU36jeJgoU7cPRpGusYMutB2', '2021-03-09 21:00:00', '2023-05-08 19:53:20', '127.0.0.1', '2023-05-08 21:53:20', 'connecte', NULL, 'VALIDE'),
(3, 3, 1, 1, 1, 0, 0, 'YAO', 'VALENTIN', NULL, '2023-05-01', '0707090196', NULL, NULL, '', 'valentin', '$2y$10$tkKteQYut.uykNHXMxZKs.tDPVeTFW1W7Qb6RfV3DovfNDctfogJC', 'vqazd4T9IUG5NIkf0vzbBvEkdMG8vfeXlxm9v0Aa5w739PhBWSMNCj8E3xAX', '2023-05-01 21:12:35', '2023-05-08 20:55:45', '127.0.0.1', '2023-05-08 22:55:45', 'connecte', NULL, 'VALIDE'),
(4, 4, 1, 1, 1, 0, 0, 'ALLANGBA', 'KOUACOU', NULL, '2023-05-01', '0707090196', NULL, NULL, '', 'allangba', '$2y$10$tkKteQYut.uykNHXMxZKs.tDPVeTFW1W7Qb6RfV3DovfNDctfogJC', 'iWUvDGcT9NxxmybxvRLuNKSaDHe72dWAzlWzQvDzQYZOAwQcsVLDHBTGPBpv', '2023-05-01 21:12:35', '2023-05-08 21:15:28', '127.0.0.1', '2023-05-08 23:15:28', 'connecte', NULL, 'VALIDE'),
(5, 5, 1, 1, 1, 0, 0, 'BOUSSOU', 'JUSTE MALACHIE', NULL, '2023-05-01', '0707090196', NULL, NULL, '', 'malachie', '$2y$10$tkKteQYut.uykNHXMxZKs.tDPVeTFW1W7Qb6RfV3DovfNDctfogJC', 'SfJEnaagFxWlKJ6sa7Q4bpUvJSIMTQZ9WSkujfadOeP3GE53btwDImOq2kmO', '2023-05-01 21:12:35', '2023-05-08 21:03:39', '127.0.0.1', '2023-05-08 23:03:39', 'connecte', NULL, 'VALIDE');

-- --------------------------------------------------------

--
-- Structure de la table `tb_users_rich*`
--

DROP TABLE IF EXISTS `tb_users_rich*`;
CREATE TABLE IF NOT EXISTS `tb_users_rich*` (
  ...
  `matricule` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `photo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `adresse_email` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `email` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `password` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `remember_token` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
--
-- Déchargement des données de la table `tb_users_rich*`
--
...
CREATE TABLE IF NOT EXISTS `vehicule` (
  `entree_sortie_id` int DEFAULT NULL,
  ...
  `vehicule_duree_limite` int DEFAULT NULL,
...
INSERT INTO `vehicule` (`entree_sortie_id`, `poste_id`, `vehicule_id`, `vehicule_code`, `vehicule_marque`, `vehicule_numero_chassis`, `vehicule_numero_ldc`, `vehicule_immatriculation1`, `vehicule_immatriculation2`, `vehicule_numero_declaration`, `vehicule_nom_conducteur`, `vehicule_duree_limite`, `vehicule_date_creation_entree1`, `vehicule_date_creation_entree2`, `vehicule_date_creation_sortie1`, `vehicule_date_creation_sortie2`, `vehicule_date_entree1`, `vehicule_date_entree2`, `vehicule_date_sortie1`, `vehicule_date_sortie2`, `vehicule_date_suppression`, `vehicule_user_entree1`, `vehicule_user_entree2`, `vehicule_user_sortie1`, `vehicule_user_sortie2`, `vehicule_statut`, `vehicule_statuts`) VALUES
(1, 1, 1, 'code 01', 'JEEP', 'chassis JEEP 01', 'ldc 01', '2794EQ01', 'imma 02', 'decla 01', 'cond koffi', NULL, '2023-04-02 12:58:01', '2023-04-03 12:58:01', '2023-04-05 12:58:01', '2023-04-07 12:58:01', '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, 'valide', 'entree1'),
(2, 2, 2, 'code 2', 'MITSUBISHI', 'chassis MITSUBISHI2', 'ldc 2', '6510JC01', 'imma 3', 'decla 2', 'cond konate', NULL, '0000-00-00 00:00:00', '2023-04-25 19:55:14', '2023-04-06 20:00:00', '0000-00-00 00:00:00', '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '1', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 3, NULL, 'MERCEDES', 'CHASSIS87', 'LDC23', '3432FRO1', '4532LL01', 'DECLA03', NULL, NULL, '2023-04-25 18:23:36', '2023-05-02 21:22:29', '2023-05-01 21:56:57', '2023-05-01 21:52:27', '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 4, NULL, 'OPEL', 'CHASSOPEL', 'LDC5056', '7049LLO1', '4532LL01', 'DECLA03', NULL, NULL, '2023-04-25 18:24:44', '2023-05-08 18:56:14', '2023-05-08 18:51:28', '2023-05-08 19:17:04', '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', '4', '3', '5', 'valide', 'entree1'),
(NULL, NULL, 5, NULL, 'SUZUKI', 'chassis SUZUKI', 'LDC 9800', '90HS01 ', 'df', 'df', NULL, NULL, '2023-05-02 21:50:00', NULL, '2023-05-08 20:30:36', NULL, '2023-05-07 22:24:26', NULL, '2023-05-10 20:30:36', NULL, NULL, '1', NULL, '3', NULL, 'valide', 'sortie1'),
(NULL, NULL, 6, NULL, 'BMWW', 'CHASSIS BMW 123409', 'LDC 120', '674HT01', '98 JA 01', 'DECLA 6598', NULL, NULL, '2023-05-05 08:00:35', NULL, '2023-05-05 08:03:37', NULL, '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 7, NULL, 'PEUGEOT', 'CHASSIS PEUGEOT 388', 'LDC 3663', '387LA01', '904 KR 01', 'DECLA 3377', NULL, NULL, '2023-05-05 08:06:08', NULL, '2023-05-05 08:07:28', NULL, '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 8, NULL, 'RENAULD', 'CHASSI-REN-2054', 'LDC 6798', '5600 KT 01', '5600 KT 01', 'DECLA 5564', NULL, NULL, '2023-05-05 12:25:45', NULL, '2023-05-08 07:07:33', '2023-05-08 07:08:18', '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 9, NULL, 'CITROEN', 'CHASSIS-CIT-2009', 'LDC 2954', '3026LP01', '5409LE01', 'DECLA 44886', NULL, NULL, '2023-05-05 12:38:03', NULL, '2023-05-05 15:17:50', NULL, '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 10, NULL, 'HYUNDAI', 'CHASSIS-HYUNDAI-223', 'LDC 344', '562 KY 01', '562 KY 01', 'DELA 4563', NULL, NULL, '2023-05-05 13:26:33', NULL, '2023-05-05 13:40:23', NULL, '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 11, NULL, 'AUDI', 'CHASSIS AUDI 3553', 'LDC 22536', '567 JU 01', '567 JU 01', 'DECLA 5566', NULL, NULL, '2023-05-08 07:12:51', '2023-05-08 07:23:17', '2023-05-08 07:20:13', '2023-05-08 07:16:35', '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '3', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 12, NULL, 'MERCEDES', 'CHASSIS87', NULL, 'FR 3344 TOY-01', '4532LL01', 'DECLA03', NULL, 10, '2023-05-08 19:39:22', NULL, NULL, NULL, '2023-05-07 22:24:26', NULL, NULL, NULL, NULL, '2', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 13, NULL, 'BMWW', 'CHASSI-TOY-01', NULL, '3432FRO1', '4532LL01', 'DECLA03', NULL, 10, '2023-05-08 20:56:40', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '3', NULL, NULL, NULL, 'valide', 'entree1'),
(NULL, NULL, 14, NULL, 'CHRISLER', 'CHASSIS87', NULL, 'FR 3344 TOY-01', '4532LL01', 'DECLA03', NULL, 10, '2023-05-08 20:59:15', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '3', NULL, NULL, NULL, 'valide', 'sortie1'),
(NULL, NULL, 15, NULL, 'CHEVROLET', 'CHASSIS BMW 123409', NULL, '3432FRO1', 'GU 6799 TOY-02', 'DECLA03', NULL, 10, '2023-05-08 21:04:11', NULL, NULL, '2023-05-08 21:09:50', NULL, NULL, NULL, '2023-05-08 21:09:50', NULL, '5', NULL, NULL, '5', 'valide', 'sortie2'),
(NULL, NULL, 16, NULL, 'VOLVO', 'CHASSI-TOY-01', NULL, 'FR 3344 TOY-01', '4532LL01', 'DECLA03', NULL, 10, '2023-05-08 21:10:32', NULL, NULL, '2023-05-08 21:14:39', NULL, NULL, NULL, '2023-05-08 21:14:39', NULL, NULL, NULL, NULL, '5', 'valide', 'sortie2'),
(NULL, NULL, 17, NULL, 'NISSAN', 'CHASSIS87', NULL, '3432FRO1', '4532LL01', 'DECLA03', NULL, 10, NULL, NULL, NULL, '2023-05-08 21:15:11', NULL, NULL, NULL, '2023-05-08 21:15:11', NULL, NULL, NULL, NULL, '5', 'valide', 'sortie2'),
(NULL, NULL, 18, NULL, 'TOYOTA E2', 'CHASSIS87', NULL, '3432FRO1', 'GU 6799 TOY-02', 'DECLA03', NULL, 10, NULL, '2023-05-08 21:15:47', NULL, NULL, NULL, '2023-05-08 21:15:47', NULL, NULL, NULL, NULL, '4', NULL, NULL, 'valide', 'entree2');
COMMIT;
