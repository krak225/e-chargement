...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 25 avr. 2023 à 23:14
...
CREATE TABLE IF NOT EXISTS `agent_douane` (
  ...
  `agent_douane_matricule` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `agent_douane_nom_prenoms` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `agent_douane_user` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `bureau_sortie` (
  ...
  `bureau_sortie_date_modification` datetime NOT NULL,
  `bureau_sortie_date_suppression` datetime NOT NULL,
  `bureau_sortie_statut` enum('brouillon','valide','supprime') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `declarant` (
  ...
  `declarant_nom` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `declarant_adresse` varchar(50) DEFAULT NULL,
  `declarant_tel` varchar(25) DEFAULT NULL,
  `declarant_mail` varchar(25) DEFAULT NULL,
  `declarant_user` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `declaration` (
  ...
  `declaration_numero` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `declaration_user` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `destinataire` (
  ...
  `destinataire_nom` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `destinataire_adresse` varchar(50) DEFAULT NULL,
  `destinataire_tel` varchar(25) DEFAULT NULL,
  `destinataire_mail` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `destinataire_user` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `detail_declaration` (
  ...
  `detail_declaration_date_modification` datetime NOT NULL,
  `detail_declaration_date_suppression` datetime NOT NULL,
  `detail_declaration_statut` enum('brouillon','valide','supprime') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `empotage` (
  ...
  `empotage_numero` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `empotage_bl_bm` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `empotage_user` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `expediteur` (
  ...
  `expediteur_nom` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `expediteur_adresse` varchar(50) DEFAULT NULL,
  `expediteur_tel` varchar(25) DEFAULT NULL,
  `expediteur_mail` varchar(25) DEFAULT NULL,
  `expediteur_user` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `marchandise` (
  ...
  `marchandise_date_modification` datetime NOT NULL,
  `marchandise_date_suppression` datetime NOT NULL,
  `marchandise_statut` enum('brouillon','valide','supprime') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `moyen_transport` (
  ...
  `moyen_transport_date_modification` datetime NOT NULL,
  `moyen_transport_date_suppression` datetime NOT NULL,
  `moyen_transport_statut` enum('brouillon','valide','supprime') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pays` (
  ...
  `pays_nom` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `pays_user` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `regime` (
  ...
  `regime_date_modification` datetime NOT NULL,
  `regime_date_suppression` datetime NOT NULL,
  `regime_statut` enum('brouillon','valide','supprime') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_users` (
  ...
  `civilite` enum('m.','mme','mlle') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `adresse_email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `remember_token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL,
  `ip_derniere_connexion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_derniere_connexion` datetime DEFAULT NULL,
  `statut_connexion` enum('connecte','deconnecte') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'deconnecte',
  `statut_signature` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `statut` enum('VALIDE','SUPPRIME') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'VALIDE',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `vehicule` (
  ...
  `vehicule_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_marque` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_numero_chassis` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_numero_ldc` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_immatriculation1` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_immatriculation2` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_numero_declaration` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_nom_conducteur` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `vehicule_user_entree1` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_user_entree2` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_user_sortie1` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_user_sortie2` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_statut` enum('brouillon','valide','supprime') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vehicule_statuts` enum('entree1','entree2','sortie1','sortie2') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
